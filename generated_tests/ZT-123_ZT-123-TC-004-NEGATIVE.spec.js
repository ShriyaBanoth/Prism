...
test.describe('ZT-123: User fails to log in with invalid email address', () => {
  ...
  test('User fails to log in with invalid email address', async ({ page }) => {
    ...
    // Expected: Error message is displayed, user is not redirected to dashboard page
    await page.click('button');
    // Step 5: Verify error message
    // Expected: Error message 'Invalid email address' is displayed below the email field
